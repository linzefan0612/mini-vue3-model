...
var isDom = function (rootContainer) {
...
function createRenderer(options) {
    // 改名字是为了 debug 方便
    var hostCreateElement = options.createElement, hostInsert = options.insert, hostPatchProp = options.patchProp, hostSelector = options.selector;
    // other code ...
...
export { createApp, createAppAPI, createElement, createRenderer, createTextVNode, getCurrentInstance, h, inject, insert, patchProp, provide, renderSlots, selector };
